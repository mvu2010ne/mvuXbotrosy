class Logging:
	...
	def debug(self, text: str) -> None:
		text = str(text)
		# Tránh dùng tiếng Việt để không lỗi Unicode trên một số terminal Windows
		print(f"{self.red} {self.log_text_color}DEBUG{self.reset} {self.textcolor}{text}")
	...
	def login(self, text: str) -> None:
		text = str(text)
		print(f"{self.yellow} {self.log_text_color}LOGIN{self.reset} {self.textcolor}{text}")
