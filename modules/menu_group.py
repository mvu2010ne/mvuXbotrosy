...
def create_menu_welcome_image(user_name, user_avatar_url, user_cover_url, bot_avatar_url, menu_text):
    ...
    draw_ribbon_trapezoid_label(base_img, text="GROUP - MENU", font_path="font/ChivoMono-VariableFont_wght.ttf", font_size=32, fill_color=(255, 255, 0))
...
╔ 👥 𝗧𝗛𝗢̂𝗡𝗚 𝗧𝗜𝗡 𝗡𝗛𝗢́𝗠
╠ 👥 𝗴𝗿𝗼𝘂𝗽.𝗜𝟰 — Xem thông tin nhóm Zalo
╠ 📊 𝗴𝗿𝗼𝘂𝗽.𝗜𝗗 — Lấy ID nhóm
╠ 🔎 𝗴𝗿𝗼𝘂𝗽.𝗙𝗶𝗻𝗱 — Tìm thông tin nhóm qua ID
╠ 🆔 𝗴𝗿𝗼𝘂𝗽.𝗚𝗲𝘁𝗜𝗗 [link] — Lấy ID từ link
╠ 🔗 𝗴𝗿𝗼𝘂𝗽.𝗚𝗲𝘁𝗟𝗶𝗻𝗸 — Lấy link mời nhóm
╚ 🔗 𝗴𝗿𝗼𝘂𝗽.𝗚𝗲𝘁𝗠𝘂𝗹𝘁𝗶𝗟𝗶𝗻𝗸 — Lấy link mời nhiều nhóm

╔ 👥 𝗧𝗛𝗔̀𝗡𝗛 𝗩𝗜𝗘̂𝗡
╠ 👥 𝗴𝗿𝗼𝘂𝗽.𝗠𝗲𝗺𝗯𝗲𝗿 — Xem danh sách thành viên
╠ 👥 𝗴𝗿𝗼𝘂𝗽.𝗮𝐝𝐝𝐌𝐞𝐦𝐛𝐞𝗿 — Danh sách thành viên (bản cũ)
╠ 🔍 𝗴𝗿𝗼𝘂𝗽.𝗙𝗶𝗻𝗱𝗨𝘀𝗲𝗿 — Tìm thành viên theo tên
╠ 🔔 𝗴𝗿𝗼𝘂𝗽.𝗙𝗶𝗻𝗱𝗧𝗮𝗴 — Gắn thẻ thành viên
╠ 🔍 𝗴𝗿𝗼𝘂𝗽.𝗟𝗶𝗻𝗸𝗙𝗶𝗻𝗱 — Tìm thành viên qua link
╠ 🔔 𝗴𝗿𝗼𝘂𝗽.𝗟𝗶𝗻𝗸𝗧𝗮𝗴 — Gắn thẻ qua link nhóm
╚ 📜 𝗴𝗿𝗼𝘂𝗽.𝗠𝘀𝗴 [ID] — Xem cuộc trò chuyện nhóm

╔ ✅ 𝗗𝗨𝗬𝗘̣̂𝗧 𝗧𝗛𝗔̀𝗡𝗛 𝗩𝗜𝗘̂𝗡
╠ ✅ 𝗴𝗿𝗼𝘂𝗽.𝗔𝗰𝗰𝗲𝗽𝘁 𝗔𝗹𝗹/𝗟𝗶𝘀𝘁 — Duyệt/xem thành viên chờ
╠ 👥 𝗴𝗿𝗼𝘂𝗽.𝐏𝐞𝐧𝐝𝐢𝐧𝐠 — Xem chi tiết thành viên chờ duyệt
╚ 👥 𝗴𝗿𝗼𝘂𝗽.deny — Tìm tên và từ chối ng.dùng khỏi danh sách chờ duyệt 

╔ 🚫 𝗤𝗨𝗔̉𝗡 𝗟𝗬́ 𝗖𝗛𝗔̣̆𝗡
╠ 🚫 𝗴𝗿𝗼𝘂𝗽.𝗕𝗮𝗻𝗨𝘀𝗲𝗿 — Xoá và chặn thành viên
╚ 🔄 𝗴𝗿𝗼𝘂𝗽.𝗨𝗻𝗹𝗼𝗰𝗸 — Mở khoá nhóm

╔ 🔓 𝗠𝗢̛̉ 𝗖𝗔̂́𝗠 / 𝗞𝗛𝗢́𝗔
╠ 🔓 𝗴𝗿𝗼𝘂𝗽.𝗨𝗻𝗯𝗮𝗻𝗨𝘀𝗲𝗿 — Gỡ cấm thành viên
╠ 👥 𝗴𝗿𝗼𝘂𝗽.𝐁𝐥𝐨𝐜𝐤𝐞𝐝 — Danh sách thành viên bị khoá
╚ 🔓 𝗴𝗿𝗼𝘂𝗽.𝗨𝗻𝗹𝗼𝗰𝗸 — Mở khoá người dùng hoặc nhóm

╔ 🖼️ 𝗖𝗢̂𝗡𝗚 𝗖𝗨̣ 𝗡𝗛𝗢́𝗠
╠ 🖼️ 𝗴𝗿𝗼𝘂𝗽.𝗔𝘃𝗮𝘁𝗮𝗿 — Đổi avatar nhóm
╠ 📊 𝗴𝗿𝗼𝘂𝗽.𝗦𝘁𝗮𝘁 — Thống kê nhóm
╠ 🗑️ 𝗴𝗿𝗼𝘂𝗽.𝗗𝗲𝗹𝗠𝘀𝗴 — Xoá 50 tin nhắn gần nhất
╚ 📩 𝗴𝗿𝗼𝘂𝗽.𝗦𝗼𝘀 — Khoá nhóm khẩn cấp

╔ 👥 𝗧𝗔̣𝗢 / 𝗚𝗜𝗔̉𝗜 𝗧𝗔́𝗡
╠ 👥 𝗴𝗿𝗼𝘂𝗽.𝐂𝐫𝐞𝐚𝐭/𝗗𝗲𝗹/𝐂𝐚𝐧𝐜𝐞𝐥 — Tạo mới/Giải tán/Huỷ
╠ 👥 𝗴𝗿𝗼𝘂𝗽.𝐂𝐚𝐧𝐜𝐞𝐥 — Huỷ giải tán
╚ 🗑️ 𝗴𝗿𝗼𝘂𝗽.𝗗𝗲𝗹 — Giải tán nhóm
...
def get_mitaizl():
    ...
    """
    return {
        'menu.group': handle_menu_command
    }