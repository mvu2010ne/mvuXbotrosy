...
def create_menu_welcome_image(user_name, user_avatar_url, user_cover_url, bot_avatar_url, menu_text):
    ...
    draw_ribbon_trapezoid_label(base_img, text="AUTOSEND", font_path="font/ChivoMono-VariableFont_wght.ttf", font_size=32, fill_color=(255, 255, 0))
...
╔ 📬 𝗔𝗨𝗧𝗢 𝗦𝗘𝗡𝗗
╠ 📬 𝗮𝘂𝘁𝗼.𝗦𝗲𝗻𝗱𝗢𝗻 — Tự động gửi tin nhắn theo lịch
╠ 📬 𝗮𝘂𝘁𝗼.𝗦𝗲𝗻𝗱𝗩𝟮 — Tự động gửi link theo lịch
╠ 📬 𝗮𝘂𝘁𝗼𝗶𝗺𝗴 — Tự động gửi ảnh theo lịch
╠ 📬 𝗮𝘂𝘁𝗼𝘀𝘁𝗸 — Tự động gửi stk theo lịch
╠ 📬 𝗮𝘂𝘁𝗼𝗹𝗶𝗻𝗸 — Gửi link ngay lập tức
╚ 📬 𝗮𝘂𝘁𝗼𝗿𝘀 — Gửi link ngay lập tức
╚ 📬 reply.sharelink — Gửi link được reply đến toàn bộ nhóm

╔ ⚙️ 𝗦𝗘𝗧 / 𝗤𝗨𝗔̉𝗡 𝗟𝗬́
╠ ⚙️ 𝗾𝘂𝗮𝗻𝗴𝗰𝗮𝗼 — Quản lý quảng cáo
╠ ⚙️ 𝗮𝗱𝗱𝘀𝗲𝘁 — Thêm set mới
╠ ⚙️ 𝘀𝗲𝗻𝗱𝘀𝗲𝘁 — Gửi tin theo set
╠ ⚙️ 𝗹𝗶𝘀𝘁𝘀𝗲𝘁𝘀 — Danh sách set
╚ ⚙️ 𝗱𝗲𝗹𝘀𝗲𝘁 — Xoá set
