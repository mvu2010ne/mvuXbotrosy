...
def create_menu_welcome_image(user_name, user_avatar_url, user_cover_url, bot_avatar_url, menu_text):
    ...
    draw_ribbon_trapezoid_label(base_img, text="CMD - MENU", font_path="font/ChivoMono-VariableFont_wght.ttf", font_size=32, fill_color=(255, 255, 0))
...
╔ ⚙️ 𝗤𝗨𝗔̉𝗡 𝗟𝗬́ 𝗗𝗢̂̀ 𝗡𝗚𝗢̂𝗡 𝗟𝗘̣̂𝗡𝗛
╠ ⚙️ 𝗰𝗺𝗱 [close/open] — Đóng/mở một hoặc nhiều lệnh
╠ ⚙️ 𝗰𝗺𝗱 [closeall/openall] — Đóng/mở toàn bộ lệnh
╠ ⚙️ 𝗰𝗺𝗱 [closeallsys/opennosys] — Đóng/mở toàn bộ lệnh trừ hệ thống
╠ ⚙️ 𝗰𝗺𝗱 list — Xem danh sách lệnh bị đóng

╔ 🛠️ 𝗧𝗢𝗢𝗟𝗦 𝗛𝗘̣̂ 𝗧𝗛𝗢̂́𝗡𝗚
╠ ⚙️ 𝗰𝗺𝗱.𝗠𝗻𝗴 — Quản lý lệnh trong hệ thống bot
╠ ✏️ 𝗰𝗺𝗱.𝗥𝗲𝗻𝗮𝗺𝗲 — Đổi tên lệnh trong /modules
╚ 🔄 𝗰𝗺𝗱.𝗦𝘆𝗻𝗰 — So sánh tên lệnh với tệp trong 'modules'
