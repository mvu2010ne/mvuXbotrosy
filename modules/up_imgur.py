...
des = {
    'tác giả': "Minh Vũ",
    'mô tả': "Upload ảnh hoặc video lên Imgur và nhận liên kết chia sẻ.",
    'tính năng': [
        "📸 Hỗ trợ upload ảnh hoặc video trực tiếp từ tin nhắn.",
        "🔗 Tự động lấy liên kết ảnh/video từ tin nhắn hoặc file đính kèm được trích dẫn.",
        "🌐 Upload lên Imgur thông qua API và trả về liên kết công khai.",
        "⚠️ Thông báo lỗi nếu không tìm thấy liên kết hoặc upload thất bại.",
        "📬 Gửi kết quả hoặc thông báo lỗi trực tiếp đến người dùng."
    ],
    'hướng dẫn sử dụng': [
        "📩 Gửi ảnh hoặc video trực tiếp trong tin nhắn để upload.",
        "📌 Hoặc phản hồi (quote) một tin nhắn chứa ảnh/video và sử dụng lệnh upimgur.",
        "✅ Nhận liên kết Imgur của ảnh/video nếu upload thành công."
    ]
}
...
def get_mitaizl():
    return {
        'up.imgur': handle_upload_command
    }
