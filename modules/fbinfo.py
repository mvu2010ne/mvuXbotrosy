...
des = {
    'tác giả': "Minh Vũ",
    'mô tả': "🔍 Lấy thông tin tài khoản Facebook từ đường link.",
    'tính năng': [
        "📋 Thu thập thông tin như tên, UID, username, ngày tạo, trạng thái, sinh nhật, follower, tích xanh, địa chỉ.",
        "🖼️ Gửi kèm ảnh đại diện nếu có.",
        "✅ Kiểm tra tính hợp lệ của link Facebook trước khi xử lý.",
        "⚠️ Thông báo lỗi chi tiết nếu API không hoạt động hoặc link không hợp lệ."
    ],
    'hướng dẫn sử dụng': [
        "📩 Gửi lệnh fbinfo <link_facebook> để lấy thông tin tài khoản.",
        "📌 Ví dụ: fbinfo https://www.facebook.com/profile.php?id=100064516230320",
        "✅ Nhận thông tin tài khoản và ảnh đại diện (nếu có) trong tin nhắn."
    ]
}
