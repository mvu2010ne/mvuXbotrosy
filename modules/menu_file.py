...
def create_menu_welcome_image(user_name, user_avatar_url, user_cover_url, bot_avatar_url, menu_text):
    ...
    draw_ribbon_trapezoid_label(base_img, text="FILE - MENU", font_path="font/ChivoMono-VariableFont_wght.ttf", font_size=32, fill_color=(255, 255, 0))
...
╔ 📤 𝗨𝗣𝗟𝗢𝗔𝗗
╠ 📁 𝘂𝗽.𝗖𝗮𝘁𝗕𝗼𝘅 — Tải file lên Catbox
╠ 📁 𝘂𝗽.𝗖𝗮𝘁𝗕𝗼𝘅𝟮 — Tải file lên Catbox lấy link
╠ ⏫ 𝘂𝗽.𝗜𝗺𝗴𝘂𝗿 — Tải ảnh lên Imgur
╠ 📂 𝘂𝗽.𝗧𝗺𝗣 — Tải file lên tmpfile
╠ 📊 𝘂𝗽.𝗷𝘀𝗼𝗻 — Lưu link ảnh vào JSON
╠ 📁 𝘂𝗽.𝗨𝗴𝘂𝘂𝘀𝗲 — Tải file lên uguu.se
╚ 📤 𝘂𝗽.𝐅𝗼𝗱𝗲𝗿 — Upload toàn bộ thư mục lên Catbox

╔ ⏬ 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗
╠ ⏬ 𝗱𝗹 — Tải file từ link bất kỳ
╠ ⏬ 𝗱𝗹𝟮 — Tải file từ link bất kỳ
╠ ⏬ 𝗱𝗹𝗺𝗲𝗱𝗶𝗮 — Tải media từ link bất kỳ
╚ ⏬ 𝗱𝗼𝘄𝗻𝟭 — Tải file từ link bất kỳ

╔ 🔗 𝗟𝗜𝗡𝗞
➜ 🎥 𝐜𝐡𝐞𝐜𝐤𝐋𝐢𝐧𝐤 — Kiểm tra trạng thái link
➜ 🔗 𝗴𝗲𝘁𝗟𝗶𝗻𝗸 — Chuyển ảnh/video thành link
➜ 🔗 𝗴𝗲𝘁𝗟𝗶𝗻𝗸𝗧𝗧 — Lấy link video TikTok từ ID hoặc URL  
➜ 📥 𝐭𝐭𝐃𝗼𝘄𝗻𝐥𝗼𝗮𝗱𝗲𝗿 — Tải video TikTok và lưu vào GainHay  
➜ 🎥 𝘃𝗶𝗱𝟮𝗪𝗲𝗯𝗣 — Chuyển video sang WebP
══════════════════════
"""
