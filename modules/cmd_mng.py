...
des = {
    'tác giả': "Minh Vũ",
    'mô tả': "🔍 Quản lý các lệnh trong hệ thống.",
    'tính năng': [
        "🗑️ Lệnh del: Xóa file lệnh khỏi thư mục modules (yêu cầu quyền admin).",
        "✏️ Lệnh rename: Đổi tên file lệnh trong thư mục modules (yêu cầu quyền admin).",
        "✅ Kiểm tra quyền admin tự động trước khi thực hiện lệnh.",
        "⚠️ Thông báo lỗi nếu cú pháp sai hoặc lệnh không tồn tại."
    ],
    'hướng dẫn sử dụng': [
        "📩 Gửi lệnh cmd.mng del <tên_lệnh> để xóa lệnh.",
        "📩 Gửi lệnh cmd.mng rename <tên_cũ> <tên_mới> để đổi tên lệnh.",
        "📌 Ví dụ: cmd.mng del test hoặc cmd.mng rename test newtest.",
        "✅ Nhận thông báo trạng thái sau khi thực hiện lệnh (chỉ admin)."
    ]
}
