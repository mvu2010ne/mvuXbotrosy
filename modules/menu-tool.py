...
OVERLAY_COLORS = [
    ...
    (255, 240, 245, 100),  # Lavender Blush
    (255, 250, 240, 100),  # Floral White
    (245, 255, 250, 100),  # Mint Cream
    (240, 248, 255, 100),  # Alice Blue
    (255, 239, 213, 100),  # Papaya Whip
    (255, 228, 225, 100),  # Misty Rose
    (255, 222, 241, 100),  # Light Pink (pastel tone)
    (255, 240, 221, 100),  # Peach (soft pastel)
    (250, 240, 230, 100),  # Linen
    (255, 245, 238, 100),  # Seashell
    (255, 255, 224, 100),  # Light Yellow
    (255, 250, 205, 100),  # Lemon Chiffon
    (255, 239, 213, 100),  # Papaya Whip (again for variety)
    (230, 230, 250, 100),  # Lavender
    (216, 191, 216, 100),  # Thistle
    (221, 182, 220, 100),  # Pale Plum
    (250, 214, 255, 100),  # Light Orchid
    (204, 255, 229, 100),  # Mint
    (224, 255, 255, 100),  # Light Cyan
    (210, 245, 255, 100),  # Light Sky Blue (pastel)
    (180, 238, 255, 100),  # Powder Blue (lighter tone)
    (200, 230, 255, 100),  # Baby Blue
    (205, 255, 253, 100),  # Pale Turquoise
    (219, 255, 219, 100),  # Honeydew
    (235, 255, 235, 100),  # Light Mint
    (255, 230, 230, 100),  # Soft Pink
    (255, 235, 205, 100),  # Blanched Almond
    (250, 222, 255, 100),  # Mauve Mist
    (255, 192, 203, 100)   # Pink (pastel variant)
]
...
def create_menu_welcome_image(user_name, user_avatar_url, user_cover_url, bot_avatar_url, menu_text):
    ...
    draw_ribbon_trapezoid_label(base_img, text="MENU", font_path="font/ChivoMono-VariableFont_wght.ttf", font_size=32, fill_color=(255, 255, 0))
...
╔ 🤖 𝗰𝗵𝗲𝗰𝗸𝗮𝗽𝗶 [𝗮𝗽𝗶] →
╠ ✅ 𝗰𝗵𝗲𝗰𝗸𝗹𝗶𝗻𝗸 — Kiểm tra trạng thái link
╠ 🩷 𝗰𝗵𝗲𝗰𝗸𝗻𝘂𝗱𝗲 — Kiểm tra nội dung nhạy cảm
╠ 🔄 𝗰𝗼𝗻𝘃𝗲𝗿𝘁 — Chuyển đổi định dạng
╠ 📜 𝗵𝘂𝗼𝗻𝗴𝗱𝗮𝗻 — Hướng dẫn sử dụng
╠ 🔗 𝗿𝘂𝘁𝗴𝗼𝗻.𝘂𝗿𝗹 — Rút gọn link
╚ 💾 𝘀𝗮𝘃𝗲 — Lưu nội dung
