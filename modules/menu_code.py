...
def create_menu_welcome_image(user_name, user_avatar_url, user_cover_url, bot_avatar_url, menu_text):
    ...
    draw_ribbon_trapezoid_label(base_img, text="CODE - MENU", font_path="font/ChivoMono-VariableFont_wght.ttf", font_size=32, fill_color=(255, 255, 0))
...
╔ 📤 𝗦𝗛𝗔𝗥𝗘 / 𝗩𝗜𝗘𝗪
╠ 📤 𝗰𝗼𝗱𝗲.𝗦𝗵𝗮𝗿𝗲 — Chia sẻ mã nguồn dưới dạng file và link
╠ 📜 𝗰𝗼𝗱𝗲.𝗩𝗶𝗲𝘄 — Xem mã nguồn của một lệnh cụ thể trong /modules
╠ 🔎 𝘀𝗿𝗰 — Xem dữ liệu gốc của tin nhắn người dùng
╚ 🔎 𝘀𝗿𝗰𝗥𝗲𝗽𝗹𝘆 — Xem dữ liệu gốc của tin nhắn được trả lời

╔ 🔍 𝗦𝗘𝗔𝗥𝗖𝗛
╠ 🔍 𝗰𝗼𝗱𝗲.𝗦𝗲𝗮𝗿𝗰𝗵 — Tìm kiếm mã nguồn trong toàn bộ /project
╠ 🔍 𝗰𝗼𝗱𝗲.𝗦𝗲𝗮𝗿𝗰𝗵/ — Tìm kiếm mã nguồn trong /modules
╚ 🔍 𝗰𝗼𝗱𝗲.𝗙𝘂𝗹𝗹𝘀𝗲𝗮𝗿𝗰𝗵/ — Tìm kiếm toàn bộ dự án

╔ 🗺️ 𝗠𝗔𝗣 / 𝗘𝗗𝗜𝗧
╠ 📜 𝗰𝗼𝗱𝗲.𝗖𝗺𝗱𝗠𝗮𝗽 — Bản đồ ánh xạ lệnh
╠ 📜 𝗰𝗼𝗱𝗲.𝗣𝗿𝗼𝗷𝗲𝗰𝘁𝗠𝗮𝗽 — Bản đồ ánh xạ project
╚ 📜 𝗰𝗼𝗱𝗲.𝗥𝗲𝗽𝗹𝗮𝗰𝗲 — Thay chuỗi văn bản trong toàn bộ project

╔ ⚙️ 𝗔𝗗𝗠𝗜𝗡 / 𝗧𝗢𝗢𝗟𝗦
╠ 📋 𝗰𝗼𝗱𝗲.𝗔𝗱𝗺𝗶𝗻𝗖𝗵𝗲𝗰𝗸 — Kiểm tra danh sách module yêu cầu quyền admin
╠ 📋 𝗰𝗼𝗱𝗲.𝗔𝗱𝗺𝗶𝗻𝗖𝗵𝗲𝗰𝗸 — Xem quyền của tất cả file Python trong /modules
╚ 📋 𝗰𝗼𝗱𝗲.𝗗𝗲𝘀𝗰 — Xem mô tả của tất cả file Python trong /modules
