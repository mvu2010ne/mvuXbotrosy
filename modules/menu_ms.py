...
def create_menu_welcome_image(user_name, user_avatar_url, user_cover_url, bot_avatar_url, menu_text):
    ...
    try:
        background = Image.open("zaloms.jpg").convert("RGB")
    ...
    draw_ribbon_trapezoid_label(base_img, text="MUSIC - MENU", font_path="font/ChivoMono-VariableFont_wght.ttf", font_size=32, fill_color=(255, 255, 0))
...
╔ 🎵 𝐦𝐬.𝐒𝐜𝐥 — Nghe nhạc SoundCloud
╠ 🎵 𝐦𝐬.𝐍𝐜𝐭 — Nghe nhạc NCT
╠ ▶️ 𝗽𝗹𝗮𝘆 𝗼𝗻/𝗼𝗳𝗳 — Bật/tắt danh sách nhạc
╚ ⏬ 𝘀𝗰𝗟𝗼𝗮𝗱 — Tải nhạc SoundCloud

╔ 🔊 r𝗲𝗮𝗱 — Đọc tin nhắn bằng giọng AI
╚ 🔊 𝘃𝗼𝗶𝗰𝗲 — Chuyển văn bản thành giọng nói

➜ ⏬ 𝗴𝗲𝘁𝗔𝘂𝗱𝗶𝗼 — Tải audio từ link
══════════════════════
"""
