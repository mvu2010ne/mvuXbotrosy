...
def create_menu_welcome_image(user_name, user_avatar_url, user_cover_url, bot_avatar_url, menu_text):
    ...
    draw_ribbon_trapezoid_label(base_img, text="BOT MENU", font_path="font/ChivoMono-VariableFont_wght.ttf", font_size=32, fill_color=(255, 255, 0))
...
MAX_MSG_LENGTH = 1500  # Giới hạn độ dài cho mỗi tin nhắn (Zalo giới hạn ~4000 ký tự)

# Tách menu thành các phần nếu quá dài
def split_menu_message(text, max_len=MAX_MSG_LENGTH):
    chunks = []
    current = ""
...
╔ 🤝 𝗞𝗘̂́𝗧 𝗕𝗔̣𝗡 & 𝗗𝗔𝗡𝗛 𝗦𝗔́𝗖𝗛
╠ 🤝 𝗯𝗼𝘁.𝗔𝗰𝗰𝗲𝗽𝘁 [ID] — Chấp nhận kết bạn 1 người
╠ 🤝 𝗯𝗼𝘁.𝗔𝗱𝗱𝗙𝗿𝗶𝗲𝗻𝗱 — Mời tất cả thành viên trong nhóm
╠ 🤝 𝗯𝗼𝘁.𝗔𝗱𝗱𝗙𝗿𝗶𝗲𝗻𝗱 [ID] — Mời 1 người dùng
╠ ❌ 𝗯𝗼𝘁.𝗰𝗮𝗻𝗰𝗲𝗹𝗿𝗲𝗾𝘂𝗲𝘀𝘁 — Huỷ tiến trình kết bạn
╠ 📋 𝗯𝗼𝘁.𝗙𝗿𝗶𝗲𝗻𝗱𝗟𝗶𝘀𝘁 — Danh sách bạn bè bot
╠ 📩 𝗯𝗼𝘁.frilist — Xem danh sách bạn bè
╠ 📋 𝗯𝗼𝘁.sentlist — Danh sách đã gửi kết bạn
╠ 📩 𝗯𝗼𝘁.rssentlist — Danh sách gửi yêu cầu
╠ 🗑️ 𝗯𝗼𝘁.cancelfri — Huỷ yêu cầu
╠ ➕ 𝗯𝗼𝘁.addfri — Gửi kết bạn
╠ ✅ 𝗯𝗼𝘁.okfri — Chấp nhận kết bạn
╠ 🗑️ 𝗯𝗼𝘁.delfri — Xoá bạn
╠ 🔄 𝗯𝗼𝘁.friupdate — Cập nhật danh sách bạn
╚ 🔎 𝗯𝗼𝘁.searchfriend — Tìm bạn

╔ 🚫 𝗖𝗛𝗔̣̆𝗡 / 𝗠𝗢̛̉ 𝗖𝗛𝗔̣̆𝗡
╠ 🚫 𝗯𝗼𝘁.𝗕𝗹𝗼𝗰𝗸 — Chặn người dùng
╠ ✅ 𝗯𝗼𝘁.𝗨𝗻𝗯𝗹𝗼𝗰𝗸 — Gỡ chặn
╚ 📩 𝗯𝗼𝘁.blickedlist — Danh sách bị chặn

╔ 👥 𝗤𝗨𝗔̉𝗡 𝗟𝗬́ 𝗡𝗛𝗢́𝗠
╠ 📋 𝗯𝗼𝘁.𝗚𝗿𝗼𝘂𝗽𝗟𝗶𝘀𝘁 — Xem tất cả nhóm tham gia
╠ ➕ 𝗯𝗼𝘁.𝗝𝗼𝗶𝗻 — Tham gia nhóm qua link
╠ ➖ 𝗯𝗼𝘁.𝗟𝗲𝗮𝘃𝗲 — Rời nhóm hiện tại
╚ ➖ 𝗯𝗼𝘁.𝗟𝗲𝗮𝘃𝗲𝗜𝗗 — Rời nhóm theo ID

╔ 📩 𝗠𝗜𝗘̂̀ 𝗠𝗜𝗘̂̀ 𝗡𝗚𝗥𝗢𝗨𝗣
╠ 📩 𝗯𝗼𝘁.𝗜𝗻𝘃𝗶𝘁𝗲 — Mời tất cả bạn bè kèm danh sách bỏ qua
╠ 📩 𝗯𝗼𝘁.𝗜𝗻𝘃𝗶𝘁𝗲𝗔𝗹𝗹 — Mời tất cả bạn bè vào nhóm
╚ 🔗 𝗯𝗼𝘁.𝗞𝗲𝘆𝗚𝗿𝗼𝘂𝗽 — Lấy link mời nhóm bot làm phó nhóm

╔ ⚙️ 𝗖𝗔̀𝗜 𝗗𝗔̣̆𝗧
╠ ⚙️ 𝗯𝗼𝘁.𝗦𝗲𝘁𝗣𝗿𝗲𝗳𝗶𝘅 — Đổi tiền tố lệnh
╠ 🗑️ 𝗯𝗼𝘁.𝗗𝗲𝗹𝗣𝗿𝗲𝗳𝗶𝘅 — Xoá tiền tố
╚ 🔄 𝗯𝗼𝘁.𝗥𝗲𝘀𝗲𝘁 — Đặt lại cấu hình mặc định

╔ ✏️ 𝗛𝗜𝗘̂̉𝗡 𝗧𝗛𝗜̣ & 𝗔𝗩𝗔𝗧𝗔𝗥
╠ ✏️ 𝗯𝗼𝘁.𝗥𝗲𝗻𝗮𝗺𝗲 — Đổi tên bot
╠ ℹ️ 𝗯𝗼𝘁.𝗜𝗻𝗳𝗼 — Xem thông tin bot
╠ 🔄 𝗯𝗼𝘁.𝗨𝗽𝗱𝗮𝘁𝗲 — Cập nhật thông tin
╚ ✅ 𝗯𝗼𝘁.𝗨𝗽𝗱𝗮𝘁𝗲𝗔𝘃𝗮𝘁𝗮𝗿 — Đổi avatar bot

╔ 🖥️ 𝗛𝗘̣̂ 𝗧𝗛𝗢̂́𝗡𝗚 & 𝗧𝗜𝗘̣̂𝗡 𝗜́𝗖𝗛
╠ 📶 𝗯𝗼𝘁.𝗡𝗲𝘁 — Kiểm tra tốc độ mạng
╠ 💻 𝗯𝗼𝘁.𝗦𝘆𝘀 — Xem thông tin phần cứng
╠ 🔄 𝗯𝗼𝘁.𝗥𝘀 — Khởi động lại bot
╠ 🎓 𝗯𝗼𝘁.𝘁𝗲𝗮𝗰𝗵 — Dạy bot trả lời
╚ 🗑️ 𝗯𝗼𝘁.𝗨𝗻𝗱𝗼 — Thu hồi tin nhắn nhóm
...
"""
    ...
    # Tách menu thành nhiều phần nếu cần
    menu_parts = split_menu_message(menu_message)

    # Gửi ảnh đầu tiên kèm phần đầu tiên của menu
    client.sendLocalImage(
        image_path,
        thread_id=thread_id,
        thread_type=thread_type,
        message=Message(text=menu_parts[0]),
        ttl=120000,
        width=1472,
        height=600
    )

    # Gửi các phần còn lại (nếu có)
    for part in menu_parts[1:]:
        time.sleep(1.2)  # tránh spam
        client.sendMessage(
            Message(text=part),
            thread_id=thread_id,
            thread_type=thread_type,
