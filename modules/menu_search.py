...
def create_menu_welcome_image(user_name, user_avatar_url, user_cover_url, bot_avatar_url, menu_text):
    ...
    try:
        background = Image.open("zalosearch.jpg").convert("RGB")
        background = background.resize((WIDTH, HEIGHT), Image.LANCZOS)
    except Exception as e:
        logging.error(f"Lỗi khi mở ảnh zalouser.png: {e}")
    ...
    draw_ribbon_trapezoid_label(base_img, text="SEACH - MENU", font_path="font/ChivoMono-VariableFont_wght.ttf", font_size=32, fill_color=(255, 255, 0))
...
╔ 🔍 𝗧𝗜̀𝗠 𝗞𝗜𝗘̂́𝗠 / 𝗧𝗥𝗔 𝗖𝗨̛́𝗨
╠ 📟 𝗮𝗰𝗰𝗟𝗤 — Lấy tài khoản Liên Quân miễn phí
╠ 🔍 𝗳𝗯𝗜𝗻𝗳𝗼 — Lấy thông tin Facebook
╠ 📡 𝗴𝗶𝘁𝗛𝘂𝗯𝗜𝟰 — Thông tin GitHub
╠ 📊 𝘁𝗧 — Tìm/tải video TikTok
╠ 🎥 𝘁𝗧𝗜𝗻𝗳𝗼 — Chi tiết video TikTok
╠ 📇 𝘁𝘁𝗜𝗻𝗳𝗼 — Thông tin TikTok
╠ 🔍 𝘄𝗶𝗸𝗶 — Tra cứu Wikipedia
╠ 🔍 𝘆𝘁𝗯 — Tìm/tải video YouTube
╠ 🔍 𝗽𝗶𝗻 — Tìm ảnh Pinterest
╠ 🔍 𝗽𝗶x — Tìm ảnh Pixil
╚ 🌐 𝗴𝗴 — Tìm kiếm trên Google

╔ 📅 𝗟𝗜̣𝗖𝗛 / 𝗚𝗜𝗢̛̀ / 𝗧𝗛𝗢̛̀𝗜 𝗧𝗜𝗘̂́𝗧
╠ 📅 𝗮𝗺𝗟𝗶𝗰𝗵 — Xem âm lịch theo ngày
╠ 📅 𝗹𝗶𝗰𝗵 — Xem lịch hôm nay
╠ 🕒 𝘁𝗶𝗺𝗲 — Xem giờ hiện tại
╚ ⛅ 𝘁𝗵𝗼𝗶𝗧𝗶𝗲𝘁 — Xem dự báo thời tiết

╔ 🌐 𝗧𝗥𝗔 𝗪𝗘𝗕 / 𝗠𝗔̃
╠ 📸 𝘄𝗲𝗯.𝘀𝘀 — Chụp màn hình web từ link
╚ 🔗 𝘄𝗲𝗯.𝗵𝘁𝗺𝗹 — Lấy mã HTML từ web

╔ 📞 𝗦𝗢̂́ / 𝗫𝗘 / 𝗧𝗔̀𝗜 𝗖𝗛𝗜́𝗡𝗛
╠ ⏬ 𝗱𝗶𝗻𝗵𝗚𝗶𝗮𝗦𝗗𝗧 — Định giá số điện thoại
╠ 🌬️ 𝗽𝗵𝗼𝗻𝗴𝗧𝗵𝘂𝘆 — Tra phong thủy số điện thoại
╠ 🚓 𝗽𝗵𝗮𝘁𝗡𝗴𝘂𝗼𝗶 — Tra cứu phạt nguội xe
╚ 📈 𝘁𝘆𝗚𝗶𝗮 — Tra tỷ giá ngoại tệ
...
def get_mitaizl():
    ...
    """
    return {
        'menu.search': handle_menu_command
    }