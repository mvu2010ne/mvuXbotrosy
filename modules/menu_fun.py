...
def create_menu_welcome_image(user_name, user_avatar_url, user_cover_url, bot_avatar_url, menu_text):
    ...
    draw_ribbon_trapezoid_label(base_img, text="FUN - MENU", font_path="font/ChivoMono-VariableFont_wght.ttf", font_size=32, fill_color=(255, 255, 0))
...
➜ 💬 𝗯𝗼𝘁 — Trò chuyện với bot AI
➜ 💬 𝗰𝗵𝗮𝘁 — Chat GPT 4
➜ 💬 𝗰𝗵𝗮𝘁 𝗰𝗹𝗲𝗮𝗿 — Hủy luồng trò chuyện hiện tại với Chat GPT 4
➜ 💬 𝗴𝗲𝗺𝗶𝗻𝗶 — Trò chuyện với Gemini
➜ 💬 𝗴𝗲𝗺𝗶𝗻𝗶 𝗰𝗹𝗲𝗮𝗿 — Hủy luồng trò chuyện hiện tại với Gemini
══════════════════════
➜ 💪 𝗱𝗲𝗣𝘁𝗿𝗮𝗶 — Đánh giá độ đẹp trai
➜ 🌈 𝗴𝗮𝘆 — Đo độ “gay” vui
➜ 💕 𝗹𝗼𝘃𝗲 — Bói tình duyên
➜ 🃏 𝘁𝗮𝗿𝗼𝘁 — Xem bói Tarot hàng ngày
➜ 📜 𝗯𝗮𝗻𝗴𝗚𝗶𝗮 — Xem bảng giá dịch vụ bot   
➜ 🔗 𝐝𝐚𝐲 — Dạy bot nội bộ  
➜ 🔗 𝐦𝐲𝐚 — Dạy bot nội bộ 
══════════════════════
"""
