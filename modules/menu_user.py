...
def create_menu_welcome_image(user_name, user_avatar_url, user_cover_url, bot_avatar_url, menu_text):
    ...
    try:
        background = Image.open("zalouser.png").convert("RGB")
...
def handle_menu_command(message, message_object, thread_id, thread_type, author_id, client):
    ...
    menu_message = """
════ 🇺 🇸 🇪 🇷 ════
➜ 🕓 𝘂𝘀𝗲𝗿.𝗖𝗿𝗲𝗮𝘁𝗧𝗶𝗺𝗲 — Kiểm tra thời gian tạo tài khoản
➜ ℹ️ 𝘂𝘀𝗲𝗿.𝗶𝟰 — Lấy thông tin người dùng Zalo
➜ 🎫 𝘂𝘀𝗲𝗿.𝗜𝗱𝗖𝗮𝗿𝗱 — Lấy ID card người dùng Zalo
➜ 👤 𝘂𝘀𝗲𝗿.𝐐𝗿 — Lấy mã QR Zalo của người dùng
➜ 👤 𝘂𝘀𝗲𝗿.𝐑𝐞𝐩𝐨𝐫𝐭 — Báo cáo người dùng
➜ 🆔 𝘂𝘀𝗲𝗿.𝗨𝗶𝗱 — Lấy UID người dùng 
══════════════════════
"""
