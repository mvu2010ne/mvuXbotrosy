...
def create_menu_welcome_image(user_name, user_avatar_url, user_cover_url, bot_avatar_url, menu_text):
    ...
    try:
        background = Image.open("zalospam.png").convert("RGB")
    ...
    draw_ribbon_trapezoid_label(base_img, text="SPAM - MENU", font_path="font/ChivoMono-VariableFont_wght.ttf", font_size=32, fill_color=(255, 255, 0))
...
╔ 📲 𝘀𝗽𝗮𝗺.𝗖𝗮𝗹𝗹 — Gọi liên tục tới số Zalo
╚ 📞 𝘀𝗽𝗮𝗺.𝗦𝗺𝘀 — Gửi nhiều cuộc gọi & tin nhắn đến số điện thoại

╠ 📩 𝘀𝗽𝗮𝗺.Hiden — Spam ẩn
╠ 📩 𝘀𝗽𝗮𝗺.𝗚𝗿𝗼𝘂𝗽L𝗶𝗻𝗸 — Gửi tin nhắn nhiều lần qua link nhóm
╠ 🎨 𝘀𝗽𝗮𝗺.𝗦𝘁𝗸 — Gửi nhiều sticker liên tục
╠ ⚠️ 𝘀𝗽𝗮𝗺.𝐦𝐮𝐥𝐭𝐢𝗦𝘁𝗸 — Gửi sticker gây lag liên tục
╚ ⚠️ 𝘀𝗽𝗮𝗺.𝗦𝘁𝗸𝗚𝗶𝗳 — Gửi sticker gif gây lag nhóm

╠ 📌 𝘀𝗽𝗮𝗺.tagall — Tag tất cả thành viên và spam
╚ 🎲 𝘀𝗽𝗮𝗺.random — Spam hỗn loạn với các thể loại spam

╔ 📊 𝘀𝗽𝗮𝗺.𝗣𝗼𝗹𝗹 — Tạo khảo sát spam liên tục
╠ ✏️ 𝘀𝗽𝗮𝗺.𝗥𝗲𝗻𝗮𝗺𝗲 — Đổi tên nhóm liên tục
╠ 🔔 𝘀𝗽𝗮𝗺.𝗧𝗮𝗴 — Gắn thẻ + spam chửi trong nhóm
╠ 📋 𝘀𝗽𝗮𝗺.𝗧𝗼𝗱𝗼𝗚𝗿𝗼𝘂𝗽 — Gửi spam Todo vào nhóm
╚ 📋 𝘀𝗽𝗮𝗺.𝗧𝗼𝗱𝗼𝗨𝘀𝗲𝗿 — Gửi spam Todo tới người dùng
══════════════════════
"""
