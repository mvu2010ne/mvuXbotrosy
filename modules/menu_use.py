...
def create_menu_welcome_image(user_name, user_avatar_url, user_cover_url, bot_avatar_url, menu_text):
    ...
    try:
        background = Image.open("zalouse.jpg").convert("RGB")
    ...
    draw_ribbon_trapezoid_label(base_img, text="USE - MENU", font_path="font/ChivoMono-VariableFont_wght.ttf", font_size=32, fill_color=(255, 255, 0))
...
╔ 👥  Group Management
╠ ➜ 👥 𝗮𝗱𝗱𝐆𝗿𝗼𝘂𝗽 — Thêm nhóm vào danh sách quản lý
╠ ➜ ❌ 𝗱𝗲𝗹𝐆𝗿𝗼𝘂𝗽 — Xóa nhóm khỏi danh sách quản lý
╚ ➜ 📋 𝗹𝗶𝘀𝘁𝐆𝗿𝗼𝘂𝗽 — Xem danh sách các nhóm đang quản lý

╔ 🙅‍♂️  Ban User
╠ ➜ 🙅‍♂️ 𝗮𝗱𝗱𝐁𝗮𝗻 — Cấm người dùng khỏi hệ thống
╠ ➜ 🔓 𝗱𝗲𝗹𝐁𝗮𝗻 — Gỡ cấm người dùng
╚ ➜ 📜 𝗹𝗶𝘀𝘁𝐁𝗮𝗻 — Xem danh sách người dùng bị cấm

╔ 🚫 Ban Group
╠ ➜ 🚫 𝗮𝗱𝗱𝐁𝐆𝗿𝗼𝘂𝗽 — Thêm nhóm vào danh sách cấm
╠ ➜ ✔️ 𝗱𝗲𝗹𝐁𝐆r𝗼𝘂𝗽 — Gỡ cấm nhóm
╚ ➜ 📑 𝗹𝗶𝘀𝘁𝐁𝐆r𝗼𝘂𝗽 — Xem danh sách nhóm bị cấm
══════════════════════
"""
