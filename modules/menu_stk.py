...
def create_menu_welcome_image(user_name, user_avatar_url, user_cover_url, bot_avatar_url, menu_text):
    ...
    try:
        background = Image.open("zalostk.jpg").convert("RGB")
    ...
    draw_ribbon_trapezoid_label(base_img, text="STICKER - MENU", font_path="font/ChivoMono-VariableFont_wght.ttf", font_size=32, fill_color=(255, 255, 0))
...
╔ 🎭 𝗦𝗧𝗜𝗖𝗞𝗘𝗥 / 𝗧𝗔̣𝗢 / 𝗤𝗨𝗔̉𝗡 𝗟𝗬́
╠ 🎭 𝗴𝗲𝘁𝗦𝘁𝗸 — Tạo sticker từ ảnh/video
╠ 🎭 𝗴𝗲𝘁𝗦𝘁𝗸𝘅𝗽 — Tạo sticker xóa phông từ ảnh
╠ 🎭 𝗴𝗲𝘁𝗦𝘁𝗸𝘃𝗱 — Tạo sticker xóa phông từ video
╠ 🎭 𝗴𝗲𝘁𝗦𝘁𝗸𝗿𝘁 — Tạo sticker từ ảnh (RT)
╠ 🗑️ 𝗱𝗲𝗹𝗦𝘁𝗸 — Xóa sticker đã lưu
╠ 📋 𝘀𝗵𝗼𝘄𝗦𝘁𝗸 — Xem danh sách sticker
╚ 🎭 𝘀𝘁𝗸 — Gửi sticker đã lưu
