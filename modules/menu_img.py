...
def create_menu_welcome_image(user_name, user_avatar_url, user_cover_url, bot_avatar_url, menu_text):
    ...
    draw_ribbon_trapezoid_label(base_img, text="IMAGE - MENU", font_path="font/ChivoMono-VariableFont_wght.ttf", font_size=32, fill_color=(255, 255, 0))
...
╔ 🔗 𝗰𝗿𝗲𝗮𝘁𝗲.𝐁𝐚𝐧𝐤𝐂𝐚𝐫𝐝 — Tạo thẻ chuyển khoản tùy chỉnh
╠ 🎨 𝗰𝗮𝗻𝘃𝗮 — Tạo thông báo tùy chỉnh
╠ 🏞️ 𝗰𝗼𝘃𝗲𝗿 — Thiết kế ảnh bìa mạng xã hội
╚ 🍑 𝘁𝗵𝗮𝗧𝗵𝗶𝗻𝗵 — Tạo ảnh thả thính

╔ 🎨 𝗮𝗿𝘁 — Tạo ảnh nghệ thuật từ văn bản
╠ 🙏 𝗯𝗮𝗻𝗧𝗵𝗼 — Tạo ảnh bàn thờ troll
╚ 🔳 𝘁𝗲𝘅𝘁𝟮𝗖𝗼𝗹𝗼𝗿 — Tạo chữ màu tùy chỉnh

╔ 🔳 𝗾𝗿 — Tạo mã QR nâng cao
╠ 🔳 𝗾𝗿𝗖𝗼𝗱𝗲 — Tạo mã QR cơ bản
╚ 🔍 𝘀𝗰𝗮𝗻𝗤𝗥 — Quét mã QR

╔ 🔎 𝗶𝗺𝗴.𝗲𝗻𝗵𝗮𝗻𝗰𝗲 — Tăng độ nét ảnh
╠ 📤 𝘂𝗽 — Cải thiện chất lượng ảnh bằng AI
╚ 🔎 𝘀𝗰𝗮𝗻𝗧𝗲𝘅𝘁 — Trích xuất văn bản từ ảnh
══════════════════════
"""
